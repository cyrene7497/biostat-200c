...
One of the assumptions of logistic regression is that the outcome variable is not measured on an interval or ration scale. The outcome variable in this dataset is CFR (case fatality rate) which is a proportion/ratio.
