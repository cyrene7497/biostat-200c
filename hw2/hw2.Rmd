...
One of the assumptions of logistic regression is that the outcome variable is not measured on an interval or ratio scale. The outcome variable in this dataset is CFR (case fatality rate) which is a proportion/ratio.
...
```{r}
summary(glm(cbind(deaths, confirmed - deaths) ~ . - county, family = binomial, data = county_data))
```
