...
```{r}
library(ggplot2)
plot1 <- ggplot(dvisits, aes(x=as_factor(age*100), y=doctorco)) + geom_bar(position = "dodge", stat = "summary", fun.y = "mean")
plot2 <- ggplot(dvisits, aes(x=as.factor(illness), y=doctorco)) + geom_bar(position = "dodge", stat = "summary", fun.y = "mean")
...
dvisits1$chronic <- as_factor(dvisits1$chronic)
ggplot(dvisits1, aes(x=chronic, y=doctorco)) + geom_bar(position = "dodge", stat = "summary", fun.y = "mean")
```
