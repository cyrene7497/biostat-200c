...
ohio %>%
  ...
  n_distinct()
```
There are 536 children, so there should be 536 unique combinations of `id` and `smoke` if the mothers did not change their smoking status. Since there are 537 unique combinations, that means one mother changed her smoking status.
